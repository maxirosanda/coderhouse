...
const dataNormalizada = normalizar(empresa, empresaSchema);
const dataDeNormalizada = denormalizar(dataNormalizada.result, empresaSchema, dataNormalizada.entities);
